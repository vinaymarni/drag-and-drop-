                ...
                switch (_a.label) {
                    ...
                    case 3:
                        if (field.type === 'SignatureField' || field.type === 'InitialField') {
                            ...
                            if (!this.signatureFieldSettings.isReadOnly && !eventArgs.cancel && target && !target.disabled && target.classList.contains('e-pdfviewer-signatureformfields') && isLeftClick) {
